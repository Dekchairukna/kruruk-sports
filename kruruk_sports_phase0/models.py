...
class SocialAccount(db.Model):
    ...
    provider = db.Column(db.String(40), nullable=False, index=True)  # google, line
...
class Invoice(db.Model):
    ...
    payment_gateway = db.Column(db.String(80), default="manual")
...
class PaymentTransaction(db.Model):
    ...
    gateway = db.Column(db.String(80), nullable=False, default="manual")  # promptpay, stripe, omise, manual
    amount = db.Column(db.Float, default=0, nullable=False)
    currency = db.Column(db.String(10), default="THB", nullable=False)
